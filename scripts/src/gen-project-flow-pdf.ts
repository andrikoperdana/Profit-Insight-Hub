...
const ID: Doc = {
  ...
  blocks: [
    ...
    { t: "b", text: "Hanya Management (atau Super Admin) yang dapat menetapkan project sebagai non-klien. Pada Projects > New Project, pilih client khusus bernama \"Internal\" — jenis project otomatis menjadi Internal dan kolom nilai berubah menjadi Internal Budget." },
    { t: "b", text: "Client tetap dipilih (yaitu client \"Internal\"); dokumen komersial seperti SPK, kontrak, dan PPN tidak digunakan. Biaya internal tetap dihitung dari Estimated Cost serta Timesheet dan Expense yang sudah APPROVED." },
...
const EN: Doc = {
  ...
  blocks: [
    ...
    { t: "b", text: "Only Management (or Super Admin) can mark a project as non-client. On Projects > New Project, choose the special client named \"Internal\" — the project kind automatically becomes Internal and the value field changes to Internal Budget." },
    { t: "b", text: "A client is still selected (the \"Internal\" client); commercial documents such as the SPK, contract, and VAT are not used. Internal cost is still computed from Estimated Cost plus APPROVED Timesheets and Expenses." },
