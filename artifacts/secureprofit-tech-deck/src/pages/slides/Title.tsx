  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-bg text-text font-body">
      <img
        ...
        alt="Circuit board data visualization"
      ...
      <div className="relative h-full flex flex-col justify-between px-[8vw] py-[7vh]">
        ...
        <div className="max-w-[72vw]">
          <div className="font-mono text-[1vw] tracking-[0.3em] text-primary uppercase mb-[3vh]">
            Technical Overview · July 2026
          </div>
          <h1 className="font-display font-bold text-[5.6vw] leading-[0.95] tracking-tight text-text text-wrap-balance">
            One contract, three apps,
            <span className="block text-primary">a single source of truth.</span>
          </h1>
          <p className="mt-[3.5vh] text-[1.6vw] text-muted max-w-[58vw] leading-snug">
            How the platform is built: the monorepo, the data flow from
            timesheet to margin, and the contracts that keep web, mobile, and
            the API server in sync.
          </p>
        </div>
